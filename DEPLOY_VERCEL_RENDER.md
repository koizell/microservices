...
- Render ejecuta cada microservicio NestJS y una base PostgreSQL compartida.
...
2. Durante la creacion completa al menos estos secretos:
...
3. Si mas adelante quieres colas reales, agrega manualmente RABBITMQ_URL en:
...
- DATABASE_URL: queda resuelta desde Render Postgres en render.yaml.
